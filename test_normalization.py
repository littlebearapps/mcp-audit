...
class TestServerNameNormalization:
    ...
    def test_codex_cli_format(self):
...
class TestToolNameNormalization:
    ...
    def test_codex_cli_normalization(self):
...
class TestPlatformSpecificUtilities:
    ...
    def test_gemini_cli_tool_normalization(self):
